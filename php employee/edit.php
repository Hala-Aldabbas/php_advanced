              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="salary" class="form-control" name="salary" placeholder="Enter salary" value="<?php echo $row['salary']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="image">Choose Image</label>
                      <div >
                        <img src="<?php echo $upload_dir.$row['image'] ?>" width="100">
                        <input style="width:300px" type="file" class="form-control mt-2" name="image" value="Choose Image">
                      </div>
                    </div>
                    <div class="form-group">
